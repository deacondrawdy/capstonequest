...
export const es: Content = {
  ...
  accessibilityPage: {
    ...
    updated: "Revisada por última vez en septiembre de 2026",
    lede: "Capstone Quest Academy quiere que todas las familias puedan usar este sitio web, incluidos los padres, abuelos y cuidadores que usan lector de pantalla, teclado en lugar de ratón, ampliación, subtítulos o control por voz.",
    standardTitle: "La norma que seguimos",
    standard: "Trabajamos conforme a las Pautas de Accesibilidad para el Contenido Web (WCAG) 2.2, nivel AA, publicadas por el World Wide Web Consortium (W3C). Es la versión actual de la norma más utilizada para evaluar si un sitio web es accesible.",
    statusTitle: "Situación actual del sitio",
    status: "El sitio cumple parcialmente con las WCAG 2.2, nivel AA. La mayor parte cumple con la norma; las excepciones que conocemos se indican abajo y estamos trabajando en ellas.",
    doneTitle: "Lo que hemos hecho",
    done: [
      "Todas las páginas se pueden usar solo con el teclado, y en cada página el primer elemento es un enlace para «Saltar al contenido principal».",
      "Cada página tiene su propio título, y los encabezados, listas y regiones están marcados para que los lectores de pantalla puedan recorrerla.",
      "Las fotos que transmiten información tienen una descripción en texto.",
      "El texto y los bordes de los campos de formulario cumplen los niveles de contraste de las WCAG 2.2 AA.",
      "El encabezado se queda en la parte superior de la pantalla, y la página está preparada para que nunca tape el control que está usando ni la sección a la que lo lleva un enlace.",
      "Las páginas funcionan con un zoom del 400 % y en pantallas de teléfono angostas sin desplazarse hacia los lados.",
      "Los formularios tienen etiquetas visibles, marcan los campos obligatorios y explican cualquier error junto al campo.",
      "Todo el sitio está disponible en inglés y en español, y cada página está marcada con su idioma.",
      "Revisamos el sitio con herramientas automáticas y a mano, página por página, en ambos idiomas, y en septiembre de 2026 lo sometimos a una auditoría independiente conforme a las WCAG 2.2 AA.",
    ],
    ...
    helpTitle: "Avísenos de una barrera o pida otro formato",
    help: "Si algo en este sitio le resulta difícil de usar, o necesita la información en otro formato —letra grande, texto sencillo o leída por teléfono—, avísenos. Díganos en qué página estaba y qué intentaba hacer.",
    emailLabel: "Correo electrónico",
    technicalTitle: "Cómo está hecho el sitio",
    technical: "El sitio usa HTML, CSS y JavaScript estándar, con WAI-ARIA donde ayuda a la tecnología de asistencia. Está diseñado para funcionar con las versiones actuales de Chrome, Safari, Firefox y Edge, y con los lectores de pantalla más comunes.",
  },
